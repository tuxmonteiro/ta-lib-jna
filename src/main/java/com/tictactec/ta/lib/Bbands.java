...
public class Bbands {
    ...
    public static Result execute(int startIdx, int endIdx, double[] inreal, int optInTimePeriod, double optInDeviationsup, double optInDeviationsdown, int optInMAType) {
