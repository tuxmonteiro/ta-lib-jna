...
public class CdlDarkCloudCover {
    ...
    private CdlDarkCloudCover() {
    }

    /**
     * Calculates the Dark Cloud Cover pattern of a given input series.
     *
     ...
     * @return a Result object containing the calculated Dark Cloud Cover pattern
