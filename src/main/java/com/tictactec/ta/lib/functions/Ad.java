...
public class Ad {
    ...
    public static Result execute(int startIdx, int endIdx, double[] high, double[] low, double[] close, double[] volume) throws ArithmeticException, IndexOutOfBoundsException {
        // Input validation
        ...
        if (retCode != 0) {
            logger.error("TA-Lib function AD returned error code: {}", retCode);
            throw new ArithmeticException("TA-Lib function AD returned error code: " + retCode);
        }
