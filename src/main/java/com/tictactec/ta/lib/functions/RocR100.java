...
public class RocR100 {
    ...
    private static final Logger logger = LoggerFactory.getLogger(RocR100.class);
    private static final TALib taLib = TALib.INSTANCE;

    /**
     * Calculates the Rate of Change Ratio 100 Scale of a given input series.
     *
     ...
     * @return a Result object containing the calculated ROCR100
    ...
    public static Result execute(int startIdx, int endIdx, double[] inreal, int optInTimePeriod) throws ArithmeticException, IndexOutOfBoundsException {
        ...
        if (retCode != 0) {
            logger.error("TA-Lib function ROCR100 returned error code: {}", retCode);
            throw new ArithmeticException("TA-Lib function ROCR100 returned error code: " + retCode);
        }
